...
export const ReviewListPage = () => {
  ...
  useEffect(() => {
    const fetchCouponReviews = async () => {
      const reviewUrl: string = `${API_BASE_URL}/api/reviews/search/findByCouponId?couponId=${couponId}&page=${currentPage - 1}&size=${reviewsPerPage}`;
  ...
  }, [couponId, currentPage, reviewsPerPage]);
